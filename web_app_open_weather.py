...
def main():
    ...
    if not dados_tempo:
        ...
        st.stop()
    if dados_tempo == 401:
        st.error("Acesso não autorizado, por favor entre em contato com o desenvolvedor")
        st.markdown("LinkedIn: [MarissaBorges](https://www.linkedin.com/in/marissaborges/)")
        st.stop()
